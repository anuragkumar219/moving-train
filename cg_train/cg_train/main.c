...
int light=1,day=1,plane=0,comet=0,xm=900,train=0,k,z=0;
char ch,a,d;
...
if(comet==1)
{
	...
	{
		glColor3f(1.0,1.0,1.0);
		draw_circle(300+c,650,l);
	}

glColor3f(1.0,1.0,1.0);
	glBegin(GL_TRIANGLES);
	glVertex2f(200+c,650);
	glVertex2f(300+c,657);
	glVertex2f(300+c,643);
	glEnd();
}
...
/*	glColor3ub(0,0,0);
	glPushMatrix();
	glTranslatef(540,290,0);
	glutSolidTorus(1,10,100,90);
	glPopMatrix();
	glColor3ub(255,191,128);
glPushMatrix();
	glTranslatef(540,289,0);
	glutSolidTorus(7,7,100,90);
	glPopMatrix();
	glColor3ub(0,0,0);*/
	glBegin(GL_LINES);
 		glVertex2i(540,289);
 		glVertex2i(540,285); //nose
  		glVertex2i(531,293);
		glVertex2i(532,294);
 		glVertex2i(532,294);
		glVertex2i(537,293);//eyebrow
  	    glVertex2i(549,293);
		glVertex2i(548,294);
		glVertex2i(548,294);
 		glVertex2i(543,293);//eyebrow
 	glEnd();
//ear right
	glBegin(GL_POLYGON);
	glColor3ub(255,191,128);
	glVertex2i(540-14,289+1);
	glVertex2i(540-14,285+1);
	glVertex2i(538-14,284+1);
	glVertex2i(538-14,290+1);
	glEnd();
	//ear left
	glBegin(GL_POLYGON);
	glColor3ub(255,191,128);
	...
	glVertex2i(539-14,287);
	glVertex2i(542-14,280);
	glVertex2i(536-14,280);
...
/*glColor3ub(0,0,0);
	glPushMatrix();
	glTranslatef(1020-220,214+76,0);
	glutSolidTorus(1,10,100,90);
	glPopMatrix();
	glColor3ub(255,191,128);
    glPushMatrix();
	...
	glColor3ub(0,0,0);*/
	glBegin(GL_LINES);
 		glVertex2i(1020-220,214+76);
 		glVertex2i(1020-220,209+76); //nose
  		glVertex2i(1011-220,219+76);
 		glVertex2i(1017-220,219+76);//eyebrow
  		glVertex2i(1023-220,219+76);
 		glVertex2i(1029-220,219+76);//eyebrow
 	glEnd();
//ear right
	glBegin(GL_POLYGON);
	glColor3ub(255,191,128);
	glVertex2i(1020-14-220,213+1+76);
	glVertex2i(1020-14-220,209+1+76);
	glVertex2i(1018-14-220,208+1+76);
	glVertex2i(1018-14-220,214+1+76);
	glEnd();
	//ear left
	glBegin(GL_POLYGON);
	glColor3ub(255,191,128);
	glVertex2i(1034-220,214+76);
	glVertex2i(1036-220,215+76);
	glVertex2i(1036-220,210+76);
	glVertex2i(1034-220,209+76);
	glEnd();
//hair
	glBegin(GL_POLYGON);
	  glColor3ub(0,0,0);
	  glVertex2i(1007-220,222+76);
	  glVertex2i(1033-220,222+76);
	  glVertex2i(1027-220,228+76);
	  glVertex2i(1013-220,228+76);
	glEnd();


	// eyes
 	glBegin(GL_POLYGON);
 		glVertex2i(1013-220,217+76);
 		glVertex2i(1015-220,217+76);
 		glVertex2i(1015-220,215+76);
 		glVertex2i(1013-220,215+76);
glEnd();
glBegin(GL_POLYGON);
 		glVertex2i(1025-220,217+76);
 		glVertex2i(1027-220,217+76);
 		glVertex2i(1027-220,215+76);
 		glVertex2i(1025-220,215+76);
glEnd();
 	// mouth
/*glBegin(GL_POLYGON);
 		glVertex2i(1015-220,216+76);
 		glVertex2i(1020-220,214+76);
 		glVertex2i(1025-220,206+76);
 		glVertex2i(1020-220,206+76);
glEnd();*/
//beard
glBegin(GL_POLYGON);
    glColor3ub(0,0,0);
    glVertex2i(1018-220,199+76);
	glVertex2i(1022-220,199+76);
	glVertex2i(1022-220,203+76);
	glVertex2i(1018-220,203+76);
glEnd();
//shirt
 	glBegin(GL_POLYGON);
 		glColor3ub(55,50,70);
	    glVertex2i(1009-220,199+76);
 		glVertex2i(1031-220,199+76);
 		glVertex2i(1046-220,188+76);
 		glVertex2i(1041-220,180+76);
 		glVertex2i(1036-220,184+76);
        glVertex2i(1036-220,164+76);
 		glVertex2i(1004-220,164+76);
 		glVertex2i(1004-220,184+76);
 		glVertex2i(999-220,179+76);
 		glVertex2i(994-220,188+76);
glEnd();
//hands
 	glBegin(GL_POLYGON);
		glColor3ub(255,191,128);
 		glVertex2i(1045-220,187+76);
 		glVertex2i(1055-220,172+76);
 		glVertex2i(1047-220,173+76);
 		glVertex2i(1042-220,181+76);
 	glEnd();
  	glBegin(GL_POLYGON);
		glVertex2i(1055-220,172+76);
 		glVertex2i(1036-220,157+76);
 		glVertex2i(1036-220,164+76);
 		glVertex2i(1047-220,173+76);
 	glEnd();
glBegin(GL_POLYGON);
	 	glVertex2i(995-220,187+76);
 		glVertex2i(985-220,172+76);
 		glVertex2i(993-220,173+76);
 		glVertex2i(998-220,181+76);
 	glEnd();
  	glBegin(GL_POLYGON);
		glVertex2i(985-220,172+76);
   		glVertex2i(1004-220,157+76);
   		glVertex2i(1004-220,164+76);
   		glVertex2i(993-220,173+76);
  	glEnd();
// belt
 	glBegin(GL_POLYGON);
		glColor3ub(150,12,30);
 		glVertex2i(1036-220,164+76);
 		glVertex2i(1004-220,164+76);
 		glVertex2i(1004-220,159+76);
		glVertex2i(1004-220,159+76);

 		glVertex2i(1036-220,159+76);
glEnd();
// collar
 	glBegin(GL_POLYGON);
		glColor3ub(200,140,110+76);
 		glVertex2i(1009-220,199+76);
 		glVertex2i(1031-220,199+76);
 		glVertex2i(1026-220,189+76);
 		glVertex2i(1014-220,189+76);
glEnd();

 	glBegin(GL_TRIANGLES);
		glColor3ub(20,140,110);
 		glVertex2i(1020-220,196+76);
  		glVertex2i(1025-220,189+76);
 		glVertex2i(1015-220,189+76);
glEnd();

// buttons
	glColor3ub(0,0,0);
	glPushMatrix();
	glTranslatef(1020-220,184+76,0);
	glutSolidTorus(1,1,100,90);
	glPopMatrix();
	glPushMatrix();
	glTranslatef(1020-220,177+76,0);
	glutSolidTorus(1,1,100,90);
	glPopMatrix();
	glPushMatrix();
	glTranslatef(1020-220,170+76,0);
	glutSolidTorus(1,1,100,90);
	glPopMatrix();
...
glVertex2i(1035-220,159+76);
glVertex2i(1005-220,159+76);
glVertex2i(1000-220,124+76);
glVertex2i(1010-220,124+76);
glVertex2i(1013-220,157+76);
glVertex2i(1030-220,124+76);
glVertex2i(1040-220,124+76);
	glEnd();
		//shoe left
	glBegin(GL_POLYGON);
	glColor3ub(100,10,10);
	glVertex2i(1010-220,124+76);
	glVertex2i(1010-220,115+76);
	glVertex2i(992-220,115+76);
	glVertex2i(1000-220,124+76);
	...
	glColor3ub(100,10,10);
	glVertex2i(1030-220,124+76);
	glVertex2i(1030-220,115+76);
	glVertex2i(1044-220,115+76);
	glVertex2i(1040-220,124+76);
	glEnd();
//signal
	glColor3f(1.0,0.0,0.0);
...
//text
glColor3f(1.0,1.0,1.0);
     glRasterPos2f(-970+i-xm,675);
     declare("IT OPERATES 9000 PASSENGER TRAINS ACROSS 25 STATES AND 3 UNION TERRITORIES");
//top
...
//text
glColor3f(1.0,1.0,1.0);
     glRasterPos2f(-280+i-xm,675);
     declare("IT IS THE LARGEST AND BUSIEST RAIL NETWORK");
...
//text
glColor3f(1.0,1.0,1.0);
     glRasterPos2f(140+i-xm,675);
     declare("IT IS OPERATED BY MINISTRY OF INDIAN RAILWAYS");
...
//text
glColor3f(1.0,1.0,1.0);
     glRasterPos2f(600+i-xm,675);
     declare("WELCOME TO INDIAN RAILWAYS- THE LIFELINE OF NATION");
...
glColor3f(1.0,1.0,1.0);
     ...
     declare("BANGALORE RAILWAY STATION");
    // z+=1;
     //if(z==10)
       // z=0;
//}
...
void main_menu(int index)
{
   ...
   declare("ARRIVAL TRAINS INFO");
   glRasterPos2f(80,470);
     declare("SAMPARK KRANTI  05:00");
     glRasterPos2f(80,450);
     declare("DURONTO EXPRESS  16:20");
     glRasterPos2f(80,430);
     declare("INTERCITY EXP  09:00");
     glRasterPos2f(80,410);
     declare("GOA EXPRESS  14:00");
     glRasterPos2f(80,390);
     declare("RAJDHANI EXP  20:00");
    glFlush();
    }
    }
	...
	case 4:if(index==4)
	{
	    for(k=0;k<=1000;k++)
        {
	      glColor3f(1.0,1.0,1.0);
	    glRasterPos2f(80,500);
     declare("DEPARTURE TRAINS INFO");
     glRasterPos2f(80,470);
     declare("SHATABDI EXP 23:05");
     glRasterPos2f(80,450);
     declare("LINK EXP  22:30");
     glRasterPos2f(80,430);
     declare("JHANSI INTERCITY 12:09");
     glRasterPos2f(80,410);
     declare("GAREEB RATH EXP 15:07");
     glRasterPos2f(80,390);
     declare("MAHARAJA EXP 17:00");
    glFlush();
        }
	}
	break;
...
printf("Lab incharges-     Bhanushree K J                  Varshitha K C\n\n");
printf("                (Assistant Professor)           (Assistant Professor)\n\n");
printf("Submitted by--      Rishabh Mishra                   Anurag Kumar\n\n");
printf("                     (1BI17CS191)                    (1BI17CS190)\n\n");
printf("Faculty incharge-       Shobha Y                     \n\n");
printf("                  (Assistant Professor)\n\n");
	...
	glutAddMenuEntry("Arrival Trains Info",3);
	glutAddMenuEntry("Departure Trains Info",4);
